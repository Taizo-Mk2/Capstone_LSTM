...
# ── 1. Read the CSV file ───────────────────────────────────────
df <- read_csv("Normalized Data/norm_Terraria_4features_ccu.csv") %>%
...
print(p)
ggsave("plot/Terraria_4features_5layers_lstm_test_prediction.png", p, width = 10, height = 5, dpi = 150)
cat("Saved: Terraria_4features_5layers_lstm_test_prediction.png\n")
...
print(p2)
ggsave("plot/Terraria_4features_5layers_lstm_training_curve.png", p2, width = 8, height = 4, dpi = 150)
cat("Saved: Terraria_4features_5layers_lstm_training_curve.png\n")
...
# ── 11. Save the model ─────────────────────────────────────────
model %>% save_model("lstm/lstm_Terraria_4features_5layers_final.keras")
cat("\n Saved: lstm_Terraria_5layers_4features_final.keras\n")

# ── Example ────────────────────────────
# loaded_model <- load_model("lstm/lstm_4features_Terraria_5layers_final.keras")
